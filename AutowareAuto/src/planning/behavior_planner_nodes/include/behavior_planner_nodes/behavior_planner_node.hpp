...
// private:
  ...
  // State variables
  std::shared_ptr<Route> m_lane_route;
  std::shared_ptr<Route> m_parking_route;
  std::shared_ptr<VehicleStateCommand> m_state_command;
  std::shared_ptr<Trajectory> m_trajectory;
  std::shared_ptr<Trajectory> m_trajectory_to_modify;
