...
:  Node("off_map_obstacles_filter", options),
  ...
  /*m_map_client_ptr(  // FIXMESB: retrieves the map from the HAD_map_service provider and uses it
                     // to filter the received bounding boxes from the euclidean cluster cloud node
