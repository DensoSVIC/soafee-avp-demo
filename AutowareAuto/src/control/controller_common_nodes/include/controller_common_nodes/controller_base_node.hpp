...
public:
  ...
  ControllerBaseNode(const std::string & name, const std::string & ns, rclcpp::NodeOptions nodeOptions);
...
// private:
  ...
  CONTROLLER_COMMON_NODES_PUBLIC void on_trajectory(const Trajectory::SharedPtr & msg);
  CONTROLLER_COMMON_NODES_PUBLIC void on_state(const State::SharedPtr & msg);
