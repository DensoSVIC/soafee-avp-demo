...
LgsvlInterfaceNode::LgsvlInterfaceNode(
    const rclcpp::NodeOptions & options,
    void* kinematic_state_action,
    void* state_report_action,
    int (*schedule_value)(void*, int64_t, void*, int)
  
): LgsvlInterfaceNode::LgsvlInterfaceNode(options)
{
    this->m_interface->m_kinematic_state_action = kinematic_state_action;
    this->m_interface->m_state_report_action = state_report_action;
    this->m_interface->schedule_value = schedule_value;
}
